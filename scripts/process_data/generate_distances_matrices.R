...
# 
# @Description: This script uses compute_distance_matrices() to both station-to-station and 
# station to geographic identifier distances over the four cities
# 
# @Summary: 
#   I.   Setup: Load dependencies, utility functions, and city-specific config.
#   II.  Import: Read raw geospatial boundaries, station location and pollution data
#   III. Process: Loop over cities and write two Parquet files per (city, year).
# 
# @Date: January 2026
# @Author: Marcos
# ============================================================================================
...
# Apply function to calculate distance matrices for CDMX
...
# Apply function to calculate distance matrices for Santiago
...
# Apply function to calculate distance matrices for São Paulo
