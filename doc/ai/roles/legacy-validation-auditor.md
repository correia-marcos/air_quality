...
Read `doc/ai/rules/validation.md`, `CLAUDE.md`, and `config_utils_validation_old_version.R`, then
...
- Artefacts go to `data/validation/<city>/<data_type>/`; they are disposable —
