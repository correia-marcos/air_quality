...
| E06 Shared client guard behavior | scripts/ai/guard_policy.py and native adapters | tests/ai/test_guard.py; installed-client discovery notes in implementation.md | open | Adapter tests are not evidence of client hook trust or runtime activation. |
